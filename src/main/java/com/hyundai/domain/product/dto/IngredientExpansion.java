...
public class IngredientExpansion {
    ...
    static {
        ...
        ingredientExpansions.put("돼지고기", List.of("돼지", "돼지고기", "돼지갈비", "삼겹살", "앞다리살", "오겹살", "돼지국밥", "베이컨류", "소시지", "양념육", "만두","분쇄가공육제품"));
    ...
    static {
        UnwandedExpansions.put("소고기", List.of("소", "소고기", "쇠고기", "소뼈", "소곱창", "한우", "양념육", "소머리", "소갈비", "소내장", "대창", "곱창", "막창", "소정육", "만두", "닭고기", "닭고기", "닭", "닭다리", "닭가슴살", "닭발", "닭넓적다리", "닭다리살", "돼지", "돼지고기", "돼지갈비", "삼겹살", "앞다리살", "오겹살", "돼지국밥", "베이컨류", "소시지", "양념육", "만두", "분쇄가공육제품", "돼지고기", "닭고기", "돼지곱창"));
